...
public class TrumpTags{
	public static long startTime;
	public static long totalNum;
	public static final long interval = 600000;
	
	public static class tagCount extends BaseBasicBolt{
		...
		public void execute(Tuple tuple, BasicOutputCollector collector){
			...
			if(System.currentTimeMillis() - startTime > TrumpTags.interval){
                ...
                while(it.hasNext()){
					...
					float frequency = (float) entry.getValue() / TrumpTags.totalNum;
	...
	public static void main(String[] args) throws Exception{
		...
		TrumpTags.startTime = System.currentTimeMillis();
		TrumpTags.totalNum = 0;
		...
		if(args  != null && args.length > 1){
		    ...
		    cluster.submitTopology("TrumpTags", conf, builder.createTopology());
